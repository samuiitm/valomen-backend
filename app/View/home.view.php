    ...
    <section class="latest-news">
        ...
        <div class="news-cards">
            <article class="news-card">
                <img src="assets/img/main/news1.webp" alt="News 1">
                <h3>One step away</h3>
                <p>Here’s how FNATIC’s players experienced the grand final.</p>
            </article>
            <article class="news-card">
                <img src="assets/img/main/news2.webp" alt="News 2">
                <h3>NRG, world champion</h3>
                <p>NRG takes the crown at VCT Champions 2025.</p>
            </article>
            <article class="news-card">
                <img src="assets/img/main/news3.webp" alt="News 3">
                <h3>ENVY promotes</h3>
                <p>ENVY earns their spot in VCT Americas 2026.</p>
            </article>
            <article class="news-card">
                <img src="assets/img/main/news4.webp" alt="News 4">
